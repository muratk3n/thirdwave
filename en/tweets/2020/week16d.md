...
"[t]he epidemiological definition of R0 is the average number of
secondary cases produced by one infected individual introduced into a
population of susceptible individuals", then, say, it takes N days for
the symptoms to occur after infection, then average of last N days
would effect the average of next N days, new cases then divided by the
past average can give an R0 estimate. The estimate shows the world has
now R0 < 1. US is not out of the woods (R0 around 1.2 but decreasing
trend).
